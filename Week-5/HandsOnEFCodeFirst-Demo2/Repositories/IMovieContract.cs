...
namespace HandsOnEFCodeFirst_Demo2.Repositories
{
    internal interface IMovieContract
    {
        ...
        Task<Movie?> GetMovieByNameAsync(string movieName); // Get a movie by its name
        ...
        Task<List<Movie>> GetMoviesByReleaseDateAsync(int year); // Get movies by release date
    }
}
